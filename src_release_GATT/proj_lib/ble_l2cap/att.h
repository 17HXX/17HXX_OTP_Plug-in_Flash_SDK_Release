...
/*Define ATT Write cb and Read cb return para*/
typedef enum{
     ATT_NO_HANDLED = 0,
     ATT_HANDLED = 1,
}ATT_RW_CB_t;

/*Define ATT Read/write cb enable bit for l2cap_att_read_write_cb_flag*/
#define ATT_READ_CB_ENABLE    BIT(0)
#define ATT_WRITE_CB_ENABLE  BIT(1)
#define	ATT_RSP_CB_ENABLE	BIT(2)
