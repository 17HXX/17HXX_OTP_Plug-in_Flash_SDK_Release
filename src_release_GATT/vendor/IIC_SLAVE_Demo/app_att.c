...
u8 ota_data[20];
const u16 userService1UUID = 0xffd0;
const u16 userSLAVE_DEV00 = 0xffd1;//global
const u16 userSLAVE_DEV0_NOTI = 0xffd3;
u8 generalValInCCC[2] = {0};
extern u8 temp_buff_from_app[20];
 ...
 * 							USER(Services) ---- use
 *************************************************************************/
	{6,2,2,		(u8*)(&my_primaryServiceUUID),	(u8*)(&userService1UUID)},
	{0,2,1,		(u8*)(&my_characterUUID),		(u8*)(&PROP_WRITE)},			//prop       use to write data to device
	{0,2,sizeof (temp_buff_from_app),	(u8*)(&userSLAVE_DEV00),			(u8*)temp_buff_from_app}, 		//value
	{0,2,1,		(u8*)(&my_characterUUID),		(u8*)(&PROP_READ_NOTIFY)},			//prop     use to receive data
	{0,2,sizeof (temp_buff_send_app),	(u8*)(&userSLAVE_DEV0_NOTI),			(u8*)temp_buff_send_app}, 		//value
