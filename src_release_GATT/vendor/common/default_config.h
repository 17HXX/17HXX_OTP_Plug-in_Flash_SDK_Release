...
#define RF_PKT_BUFF_LEN			256			//  proprietary protocal
...
//for ramcode optimize
#ifndef FLASH_OP_DISABLE_IRQ
#define FLASH_OP_DISABLE_IRQ						1
#endif

#ifndef ANALOG_OP_DISABLE_IRQ
