...
void set_freq_offset_flash(u8 offset);
void set_freq_offset_OTP(u8 offset);
u32 read_chip_ID_OTP();
u32 read_chip_ID_flash();
void set_mac_OTP(u8 *tmac);
void set_mac_flash(u8 *tmac);
